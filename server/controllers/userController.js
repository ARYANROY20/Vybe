...
export const updateUserData=async (req,res) => {
    try {
        ...
        { 
            ...
            if(user){
                //we will not change the username if it is alraedy taken
        ...
        const allUsers=await User.find(
            {
                $or:[
                    ...
                    {email:new RegExp(input,'i')},{full_name:new RegExp(input,'i')},
    ...
    try {
        ...
        if(!connection){
           const newConnection= await Connection.create({
            ...
            return res.json({success:false,message:'You hare already connected with user'})
        }
